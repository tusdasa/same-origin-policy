...
\begin{frame}{存在跨域的情况}
    \begin{table}
        \begin{tabular}{l l c l}
            ...
            \bottomrule
        \end{tabular}
        \caption{\href{https://developer.mozilla.org/zh-CN/docs/Web/Security/Same-origin_policy}{不同源明细} \footfullcite{https://developer.mozilla.org/zh-CN/docs/Web/Security/Same-origin_policy}  } 
    \end{table}
\end{frame}
